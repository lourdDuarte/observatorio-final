...
function ipc(){
  ...
  chart = draw_line_chart( intermensual_actual ,interanual_actual ,meses_actual,'Datos IPC','chartIpc')
  chartHistorico = draw_line_chart(interanual_filtro, intermensual_filtro, meses_filtro,'Datos IPC','chartIpcHistorico')
